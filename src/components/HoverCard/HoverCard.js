        ...
        <div className="hover__container">
          <main ref={(el) => (this.list = el)}>
            {Array.from(Array(5)).map((item, idx) => {
              return (
                <article
                  className="hover__main"
                  onMouseOver={() => {
                    this.scrollHandler(idx + 1);
                  }}
                >
                  <img
                    alt="thumbnail"
                    src={
                      "https://i.picsum.photos/id/646/300/400.jpg?grayscale&hmac=qLPwdXQfBZOsxl7vdAs_cFNbgeONcFRnCpfjxT4fW_Y"
                    }
                  ></img>
                  <header>
                    <h4>Object</h4>
